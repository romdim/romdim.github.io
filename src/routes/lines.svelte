...
<div class="absolute inset-1/2 transform -translate-x-1/2 -translate-y-1/2 box font-mono">
  <div class="box relative">
    ...
    <div class="hl-animation w-screen-min bg-black transform origin-center rotate-45 absolute inset-1/2 -translate-x-1/2"></div>
    <div class="hl-animation w-screen-min bg-black transform origin-center -rotate-45 absolute inset-1/2 -translate-x-1/2"></div>
  </div>
</div>