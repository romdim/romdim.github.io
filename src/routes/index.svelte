...
<div class="absolute inset-1/2 lg:grid lg:grid-cols-12 transform -translate-x-1/2 -translate-y-1/2 box">
  <div class="relative lg:col-start-2 lg:col-span-10 max-w-screen-3.1xl box">
    <!-- Logo -->
