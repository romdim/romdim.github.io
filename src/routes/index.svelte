...
<div class="absolute inset-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white font-mono box">
  ...
  <!-- Description -->
  <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-96 lg:bottom-1/4 lg:left-3/4 lg:translate-y-1/2 text-size-responsive lg:text-2.5xl text-center lg:text-right text-black lg:leading-looser">
    <!-- flex items-center -->
  ...
  <!-- Horizontal line -->
  <div class="hl-animation h-0.5 w-screen max-w-screen-3xl absolute top-1/2 -translate-y-1/2 bg-black hidden lg:block"></div> 
  <!-- Vertical line -->
  <div class="vl-animation w-0.5 h-screen absolute top-0 left-1/2 -translate-x-1/2 bg-black hidden lg:block"></div>
